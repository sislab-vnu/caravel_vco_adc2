...
set_output_delay 0.7000 -clock [get_clocks {clk}] -rise -max -add_delay [get_ports {user_irq[0]}]
set_output_delay 0.7000 -clock [get_clocks {clk}] -fall -max -add_delay [get_ports {user_irq[0]}]
set_output_delay 0.7000 -clock [get_clocks {clk}] -rise -max -add_delay [get_ports {user_irq[1]}]
set_output_delay 0.7000 -clock [get_clocks {clk}] -fall -max -add_delay [get_ports {user_irq[1]}]
set_output_delay 0.7000 -clock [get_clocks {clk}] -rise -max -add_delay [get_ports {user_irq[2]}]
set_output_delay 0.7000 -clock [get_clocks {clk}] -fall -max -add_delay [get_ports {user_irq[2]}]
